---
name: describe-mr
description: "Генерирует текстовое описание Merge Request на русском языке. Используй этот скилл когда пользователь передаёт ссылку на MR (например /describe-mr https://gitlab.../merge_requests/123), или просит написать, сгенерировать описание PR/MR. Скилл только генерирует текст — не публикует его. Для создания нового MR — используй скилл create-mr."
---
